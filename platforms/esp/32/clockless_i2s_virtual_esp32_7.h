...
#define I2S_OFF NUM_VIRT_PINS * NUM_LEDS_PER_STRIP
...
static    void transpose16x1_noinline2(unsigned char *A, uint8_t *B) {
    ...
    */
     ...
     *((uint16_t*)(B)) = (uint16_t)(   (   (x & 0xff000000) >>24 |  (  (x1 & 0x7f000000) >>16)   )  );
   ...
   // B[0]= (uint16_t)(   (   (x & 0xff000000) >>24 |  (  (x1&0xff000000) >>16)   )  );
    //B+=48;//offset;
   *((uint16_t*)(B+48)) = (uint16_t)( ((x & 0xff0000) >>16|((x1&0x7f0000) >>8)));
   // B[48] = (uint16_t)( ((x & 0xff0000) >>16|((x1&0xff0000) >>8)));
    //+=48;//offset;
        *((uint16_t*)(B+2*48)) = (uint16_t)(((x & 0xff00) |((x1&0x7f00) <<8))>>8);
  // B[2*48]  = (uint16_t)(((x & 0xff00) |((x1&0xff00) <<8))>>8);
   // B+=48;//offset;
    *((uint16_t*)(B+3*48)) =(uint16_t)( (x & 0xff) |((x1&0x7f) <<8));
  // B[3*48] =(uint16_t)( (x & 0xff) |((x1&0xff) <<8));
     //B+=48;//offset;
   
    *((uint16_t*)(B+4*48)) = (uint16_t)(((y & 0xff000000) >>8 |((y1&0x7f000000) ))>>16);
  // B[4*48]= (uint16_t)(((y & 0xff000000) >>8 |((y1&0xff000000) ))>>16);
    
     *((uint16_t*)(B+5*48)) = (uint16_t)(((y & 0xff0000) |((y1&0x7f0000) <<8))>>16);
 //B[5*48]=  (uint16_t)(((y & 0xff0000) |((y1&0xff0000) <<8))>>16);
    
    *((uint16_t*)(B+6*48)) = (uint16_t)(((y & 0xff00) |((y1&0x7f00) <<8))>>8);
 // B[6*48]=    (uint16_t)(((y & 0xff00) |((y1&0xff00) <<8))>>8);
   
    
    *((uint16_t*)(B+7*48)) = (uint16_t)((y & 0xff) |  (  (y1 & 0x7f) << 8 ) )   ;
